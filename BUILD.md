...
| AND-007 | android | Implementer les ecrans `Home`, `Library`, `Downloads`, `Settings`, `Player` complet et refonte UI Playlists | in_progress | AND-002, AND-003, AND-004 | `docs/android/screens/home.md`, `docs/android/screens/library.md`, `docs/android/screens/downloads.md`, `docs/android/screens/settings.md`, `docs/android/screens/player.md`, `docs/android/screens/player-layout.md`, `docs/android/screens/playlists-layout.md` | le travail detail `Artist` / `Album` est suivi separement pour clarifier les dependances backend et metadata |
