...
| AND-007 | android | Implementer les ecrans `Artist`, `Album`, `Home`, `Library`, `Downloads`, `Settings`, `Player` complet | in_progress | AND-002, AND-003, AND-004 | `docs/android/screens/artist.md`, `docs/android/screens/album.md`, `docs/android/screens/home.md`, `docs/android/screens/library.md`, `docs/android/screens/downloads.md`, `docs/android/screens/settings.md`, `docs/android/screens/player.md`, `docs/android/screens/player-layout.md` | surfaces Android enrichies, verification Gradle laissee a l'utilisateur selon AGENTS.md |
...
| DOC-006 | docs | Generer et valider les schemas de layouts (-layout.md) ecran par ecran | in_progress | DOC-005 | `docs/android/screens/*-layout.md` | home-layout et library-layout valides et implementes. Reste : search, player, settings, downloads, artist, album |
