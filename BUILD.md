...
| AND-005 | android | Implementer l'ecran `Search` avec orchestration local + online | in_progress | AND-002, AND-003, SRV-002 | `docs/android/screens/search.md`, `docs/product/user-flows.md`, `docs/server/api-contract.md` | backend SRV-002 pret ; UI et local implémentés, fix réseau et Moshi polymorphe en cours |
