...
| AND-005 | android | Implementer l'ecran `Search` avec orchestration local + online | in_progress | AND-002, AND-003, SRV-002 | `docs/android/screens/search.md`, `docs/product/user-flows.md`, `docs/server/api-contract.md` | UX validee avec TabRow Bibliotheque/En ligne. Playlists exclues du perimetre Search. Le bloc online attend un backend qui renseigne `tracks`, `artists` et `albums` de maniere coherente. |
...
| AND-007 | android | Implementer les ecrans `Home`, `Library`, `Downloads`, `Settings`, `Player` complet et refonte UI Playlists | completed | AND-002, AND-003, AND-004 | `docs/android/screens/home.md`, `docs/android/screens/library.md`, `docs/android/screens/downloads.md`, `docs/android/screens/settings.md`, `docs/android/screens/player.md`, `docs/android/screens/player-layout.md`, `docs/android/screens/playlists-layout.md` | l'intégration client Android complète des téléchargements asynchrones est implémentée avec succès et suit le modèle Flat de jointure SQL Room |
...
| SRV-003 | backend | Implementer les endpoints de sync cloud optionnelle `/me/...` | not_started | SRV-001 | `docs/server/api-contract.md`, `docs/server/database-postgres.md` | sync user-scoped, inclura mise en place HTTPS/Caddy |
