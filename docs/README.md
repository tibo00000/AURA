...
50. `docs/android/screens/cloud-sync.md`
51. `docs/android/screens/cloud-sync-layout.md`
52. `docs/desktop/app-architecture.md`
53. `docs/server/architecture.md`
54. `docs/server/api-contract.md`
55. `docs/server/sync-conflict-resolution.md`
56. `docs/server/sync-batch-api.md`
57. `docs/server/api-sync-flows.md`
58. `docs/server/jobs.md`
59. `docs/server/database-postgres.md`
60. `docs/server/postgres-relationships.md`
61. `docs/server/vector-search-qdrant.md`
62. `docs/server/storage.md`
63. `docs/server/providers/deezer.md`
64. `docs/server/providers/streaming-bridge.md`
65. `docs/server/security-and-secrets.md`
66. `docs/mcp/overview.md`
67. `docs/mcp/resources.md`
68. `docs/mcp/use-cases.md`
69. `docs/ops/logging-observability.md`
70. `docs/ops/env-vars.md`
71. `docs/ops/hosting-strategy.md`
